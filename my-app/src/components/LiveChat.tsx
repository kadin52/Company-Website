...
export default function LiveChat() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Chat Window */}
      {isOpen && (
        <div className="bg-gray-300 border border-gray-300 rounded-lg shadow-xl flex flex-col h-96 w-80 mb-4 overflow-hidden">
          ...
          <div className="flex-1 p-3 overflow-y-auto flex flex-col gap-2 bg-gray-300">
            ...
            {messages.map((msg) => (
              <div
                key={msg.id}
                className="bg-orange-100 p-2 rounded-md text-sm w-fit max-w-[80%] self-end"
              >
